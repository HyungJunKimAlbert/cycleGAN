...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, data_dir, transform=None, data_type='both'):
        ...
        if os.path.exists(self.data_dir_a):
            ...
            lst_data_a = [f for f in lst_data_a if f.endswith('jpg') | f.endswith('jpeg') | f.endswith('png') |  f.endswith('tiff')]    
            lst_data_a.sort()
        else:
            lst_data_a = []
        ...
        if os.path.exists(self.data_dir_b):
            ...
            lst_data_b = [f for f in lst_data_b if f.endswith('jpg') | f.endswith('jpeg') | f.endswith('png') |  f.endswith('tiff')]    
            lst_data_b.sort()
        else:
            lst_data_b = []
